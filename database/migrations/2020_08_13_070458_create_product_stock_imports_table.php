...
class CreateProductStockImportsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('product_stock_imports', function (Blueprint $table) {
            $table->id();
            $table->uuid('uuid');
    ...
    {
        Schema::dropIfExists('product_stock_imports');
    }
}
