...
@section('content')
    <div class="ecam-crud" id="users">
        {!! Form::open(['route' => 'users.store', 'method' => 'post', 'class'=>'needs-validation','id'=>'fm-create-permission','novalidate']) !!}
        <div class="row">
            <div class="col-12">
                <div class="card card-crud crud-list">
                    <div class="card-header bg-white crud-header">
                        <div class="row">
                            <div class="col-6">
                                <div class="card-title crud-tittle">Create New User</div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control {{ $errors->has('email')?'is-invalid':'' }}" type="email" value="{{ old('email') }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control {{ $errors->has('username')?'is-invalid':'' }}" type="text" value="{{ old('username') }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control {{ $errors->has('password')?'is-invalid':'' }}" type="password"
                                           id="password" name="password" placeholder="Enter password" maxlength="100" required/>
                                    {!!  $errors->has('password') ? showError($errors->first('password')) : ''  !!}
                                </div>
                                <div class="form-group">
                                    <label for="password_confirmation" class="form-label">Re-Password</label><span class="text-danger pl-1">*</span>
                                    <input class="form-control {{ $errors->has('password_confirmation')?'is-invalid':'' }}" type="password"
                                           id="password_confirmation" name="password_confirmation" placeholder="Enter password confirmation" maxlength="100" required/>
