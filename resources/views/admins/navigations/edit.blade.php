...
@section('content')
    <div class="ecam-crud" id="navigations">
        {!! Form::open(['route' => ['navigations.update',encrypt($navigation->id)], 'method' => 'post', 'class'=>'needs-validation','id'=>'fm-update-navigations','novalidate']) !!}
        <div class="row">
            <div class="col-12">
                            ...
                            <div class="col-12">
                                <div class="form-row">
                                    <div class="form-group col-12">
                                        ...
                                        <input class="form-control {{ $errors->has('name')?'is-invalid':'' }}" type="text" value="{{ $navigation->name }}"
                                ...
                                <div class="form-row">
                                    <div class="form-group col-6">
                                        ...
                                        <input class="form-control {{ $errors->has('link')?'is-invalid':'' }}" type="text" value="{{ $navigation->link }}"
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <input class="form-control {{ $errors->has('icon')?'is-invalid':'' }}" type="text" value="{{ $navigation->icon }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="custom-select form-control {{ $errors->has('parent')?'is-invalid':'' }}" name="parent" id="parent">
                                        ...
                                        @foreach($navigation_parents as $parent)
                                            <option value="{{ encrypt($parent->id) }}" {{ $navigation->parent_id==$parent->id?'selected':'' }}>{{ $parent->name }}</option>
                                        @endforeach
                                    </select>
