...
@section('title','All Navigations')

@section('page-name-class', 'navigations')

@section('breadcrumbs',Breadcrumbs::render('navigations'))
@section('content')
    <div class="row ecam-crud list" id="navigations">
        <div class="col-12">
            <div class="card card-crud crud-list">
                <div class="card-header bg-white crud-header">
                    <div class="row">
                        <div class="col-6">
                            <div class="card-title crud-tittle">List Navigations</div>
                        </div>
                        <div class="col-6">
                            <div class="btn-group btn-group-sm pull-right crud-btn-group">
                                @can('navigations','create')
                                    <a class="btn btn-sm btn-info btn-add m-1" href="{{ route('navigations.create') }}">
                ...
                <div class="card-body padding-12 crud-body">
                    <div class="table-responsive table-responsive-md table-responsive-sm text-nowrap">
                        <table id="navigation-table"
                               ...
                               data-route="{{ route('admin.navigations.index') }}">
                            <thead>
                            <tr>
                                <th class="th-sm">#</th>
            ...
            <div class="sidebar-filter collapse " id="sidebar-filter" data-parent="#ecam">
                <div class="wrapper">
                    ...
                    <div class="filter-body p-3">
                        <div class="row">
                            <div class="col-12">
                                {!! Form::open(['id' => 'form-navigation-filter','autocomplete'=>'off']) !!}
...
@push('admin-js')
    <script src="{{ mix('js/admins/pages/navigations.js') }}"></script>
@endpush
