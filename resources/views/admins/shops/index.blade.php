...
@section('page-name-class', 'shop')

@section('breadcrumbs',Breadcrumbs::render('shops'))
@section('content')
    <div class="row ecam-crud list" id="shops">
        <div class="col-12">
            <div class="card card-crud crud-list">
                <div class="card-header bg-white crud-header">
                    <div class="row">
                        <div class="col-6">
                            <div class="card-title crud-tittle">List Shops</div>
                        </div>
                        <div class="col-6">
                            <div class="btn-group btn-group-sm pull-right crud-btn-group">
                                @can('shops','create')
                                    <a class="btn btn-sm btn-info btn-add m-1" href="{{ route('shops.create') }}">
                ...
                <div class="card-body padding-12 crud-body">
                    <div class="table-responsive table-responsive-md table-responsive-sm text-nowrap">
                        <table id="shop-table"
                               ...
                               data-route="{{ route('admin.shops.index') }}">
                            <thead>
                            <tr>
                                <th class="th-sm">#</th>
            ...
            <div class="sidebar-filter collapse " id="sidebar-filter" data-parent="#ecam">
                <div class="wrapper">
                    ...
                    <div class="filter-body p-3">
                        <div class="row">
                            <div class="col-12">
                                {!! Form::open(['id' => 'form-shop-filter','autocomplete'=>'off']) !!}
                                <div class="form-group ">
                                    <label for="name-shop">Name</label>
                                    <input type="text" class="form-control" name="name" id="name-shop" placeholder="Enter shop name"/>
                                </div>
                                <div class="form-group ">
                                    <label for="shop-location">Location</label>
                                    <select class="form-control" name="status" id="shop-location">
                                        <option value="0" selected disabled>--Select Location--</option>
                                        <option value="1">Phnom Penh</option>
                                        <option value="2">Kandel</option>
                                    </select>
                                </div>
                                <div class="form-group">
...
@push('admin-js')
    <script src="{{ mix('js/admins/pages/shop.js') }}"></script>
@endpush
